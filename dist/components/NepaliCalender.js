...
var calendarData = {
  ...
  //     [0,2, 3, 1, 2, 2, 1, 3, 2, 2, 1, 2, 3, 1, 3, 1,2, 1, 3, 2, 1, 3, 1, 1,1,1, 1, 3, 1, 2, 2, 2, 2, 2, 2, 2, 1, 3, 1, 3, 1, 3, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 3, 1, 3, 1, 2, 2, 2, 15, 2, 4],
...
const NepaliCalender = ({
  ...
  function getMonthDaysNumFormMinBsYear(bsMonth, yearDiff) {
    ...
    validationFunctions.validateBsMonth(bsMonth);
    validationFunctions.validatePositiveNumber({
      "yearDiff": yearDiff
    });
    var yearCount = 0;
  ...
  const dayLoad = () => {
    ...
    list.push( /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, weekDays)));
    ...
    for (let i = 1; i <= bsMonthUpperDay;) {
      ...
      for (let j = 0; j < 7 && i <= bsMonthUpperDay; j++) {
        ...
        if (weekDayTracker < weekDayStartFrom) {
          tempdays.push( /*#__PURE__*/React.createElement("td", {
            key: weekDayTracker + "emptycell"
          }, " "));
          weekDayTracker++;
        } else {
          tempdays.push( /*#__PURE__*/React.createElement("td", {
      ...
      daylist.push( /*#__PURE__*/React.createElement("tr", null, tempdays));
    }
    let table = [];
    list.push( /*#__PURE__*/React.createElement("tbody", null, daylist));
    table.push( /*#__PURE__*/React.createElement("table", null, list));
    return table;
  };
  const monthLoad = () => {
    let list = [];
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("input", {
    ...
    className: "pick apply-shadow"
  }, yearLoad()), /*#__PURE__*/React.createElement("div", {
    className: "pick"
  }, monthLoad()), /*#__PURE__*/React.createElement("div", {
    className: "day-pick apply-shadow"
  }, dayLoad())));
};
const styles = {
  modalVisible: {
